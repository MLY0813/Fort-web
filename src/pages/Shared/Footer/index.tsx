    ...
    return (
        <footer>
            <div className={`${footer}-left`}>
                <button onClick={switchLang('en-US')}><EnglishIcon className={`${footer}-left-english`}/></button>
                <button onClick={switchLang('zh-CN')}><ChineseIcon className={`${footer}-left-chinese`}/></button>
            </div>
